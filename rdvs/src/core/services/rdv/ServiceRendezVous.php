...
use rdvs\core\dto\InputRendezVousDTO;
use rdvs\core\dto\RendezVousDTO;
use rdvs\core\repositoryInterfaces\PraticienRepositoryInterface;
...
use rdvs\core\services\praticien\ServicePraticienInvalidDataException;
...
class ServiceRendezVous implements ServiceRendezVousInterface
{
    ...
    private PraticienProviderInterface $praticienRepository;


    public function __construct(RdvRepositoryInterface $rdvRepository, PraticienProviderInterface $praticienRepository)
    {
    ...
    public function creerRendezvous(InputRendezVousDTO $rdv): RendezVousDTO
    {
        ...
        try {
            if ($this->praticienRepository->getPraticienById($rdv->praticien)['specialite_id'] != $rdv->specialite) {
        ...
        $id_new_rdv = $this->rendezvousRepository->save($rendezvous);

        $rendezvous->setID($id_new_rdv);
